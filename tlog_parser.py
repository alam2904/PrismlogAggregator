...
class TlogParser:
    ...
    def parse_prism(self, validation_object, tlog_data_automation_outfile):
        """
        ...
        if tlog_object.get_prism_billing_tlog(validation_object, tlog_data_automation_outfile):
            logging.info('prism tlog data found')
            if not validation_object.is_tlog:
    ...
    def parse_tomcat(self, validation_object, tlog_data_automation_outfile):
        """
        ...
        if tlog_object.get_tomcat_billing_tlog(validation_object, tlog_data_automation_outfile):
    ...
    def parse_sms(self, validation_object, tlog_data_automation_outfile):
        """
        ...
        if tlog_object.get_sms_tlog(validation_object, tlog_data_automation_outfile):
            logging.info('sms tlog data found')
            if not validation_object.is_tlog:
